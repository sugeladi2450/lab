...
static inline __m256i mul_sum_us8_pairs_int(const __m256i ax,
											const __m256i sy) {
...
static block_q4_0x4 make_block_q4_0x4(block_q4_0 *in,
	...
	for (int i = 0; i < QK4_0 * 2; i++) {
		int src_offset =
			(i / (4 * blck_size_interleave)) * blck_size_interleave;
...
static block_q4_0x8 make_block_q4_0x8(block_q4_0 *in,
	...
	for (int i = 0; i < QK4_0 * 4; i++) {
		int src_offset =
			(i / (8 * blck_size_interleave)) * blck_size_interleave;
...
void quantize_q8_0_4x4(const float *restrict x, void *restrict vy, int64_t k) {
	...
	for (int i = 0; i < nb; i++) {
		...
		for (int row_iter = 0; row_iter < 4; row_iter++) {
			for (int j = 0; j < 8; j++)
				srcv[row_iter][j] =
					vld1q_f32(x + row_iter * k + i * 32 + 4 * j);
			for (int j = 0; j < 8; j++)
	...
	for (int i = 0; i < nb; i++) {
		...
		for (int j = 0; j < QK8_0 * 4; j++) {
			int src_offset =
				(j / (4 * blck_size_interleave)) * blck_size_interleave;
			int src_id =
				(j % (4 * blck_size_interleave)) / blck_size_interleave;
...
void quantize_q8_0_4x8(const float *restrict x, void *restrict vy, int64_t k) {
	...
	for (int i = 0; i < nb; i++) {
		for (int row_iter = 0; row_iter < 4; row_iter++) {
			...
			id[row_iter]  = (maxScalar != 0.0f) ? 127.f / maxScalar
												: 0.0f; // d ? 1.0f / d : 0.0f;

			// Store the scale for the individual block
			y[i].d[row_iter] = GGML_FP32_TO_FP16(d);

			// Store the values in blocks of eight values - Aim is to use these
			// later for block interleaving
			srcv[row_iter][0] = v0;
			srcv[row_iter][1] = v1;
			srcv[row_iter][2] = v2;
			srcv[row_iter][3] = v3;
		...
		// The loop iterates four times - The aim is to get 4 corresponding
		// chunks of eight bytes from the original weight blocks that are
		// interleaved
		for (int j = 0; j < 4; j++) {
			...
			//  Permute and store the quantized weights in the required order
			//  after the pack instruction
...
void quantize_mat_q8_0(const float *restrict x, void *restrict vy, int64_t nrow,
...
static size_t quantize_q4_0_nr_bl(const float *restrict src, void *restrict dst,
	...
	for (int b = 0; b < (nrow * n_per_row);
		 b += nrows_interleaved * n_per_row) {

		for (int64_t x = 0; x < nb; x++) {

			for (int i = 0; i < nrows_interleaved; i++) {
				quantize_row_q4_0_ref(src + b + i * n_per_row + x * QK4_0,
									  (block_q4_0 *)dst_tmp + i, QK4_0);
			}

			if (nrows_interleaved == 8) {
				*(block_q4_0x8 *)out_ptr =
					make_block_q4_0x8(dst_tmp, blck_size_interleave, 0x88);
				out_ptr = (block_q4_0x8 *)out_ptr + 1;
			} else if (nrows_interleaved == 4) {
				*(block_q4_0x4 *)out_ptr =
					make_block_q4_0x4(dst_tmp, blck_size_interleave, 0x88);
...
size_t quantize_q4_0_4x4(const float *restrict src, void *restrict dst,
						 int64_t nrow, int64_t n_per_row,
...
size_t quantize_q4_0_4x8(const float *restrict src, void *restrict dst,
						 int64_t nrow, int64_t n_per_row,
						 const float *quant_weights) {
	UNUSED(quant_weights);
...
size_t quantize_q4_0_8x8(const float *restrict src, void *restrict dst,
						 int64_t nrow, int64_t n_per_row,
						 const float *quant_weights) {
	UNUSED(quant_weights);
...
void ggml_gemv_q4_0_4x4_q8_0(int n, float *restrict s, size_t bs,
	...
	GGML_ASSERT(!(ggml_cpu_has_neon() && ggml_cpu_has_matmul_int8()) &&
				"__ARM_NEON and __ARM_FEATURE_MATMUL_INT8 defined, use the "
	...
	__asm__ __volatile__(
		...
		: "memory", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23",
		  "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31", "x20", "x21",
		  "x22");
#else
	float sumf[4];
	int sumi;
...
void ggml_gemv_q4_0_4x8_q8_0(int n, float *restrict s, size_t bs,
							 const void *restrict vx, const void *restrict vy,
							 int nr, int nc) {
	const int qk				= QK8_0;
	const int nb				= n / qk;
	...
	GGML_ASSERT((ggml_cpu_has_sve() || ggml_cpu_has_matmul_int8()) &&
				"__ARM_FEATURE_SVE and __ARM_FEATURE_MATMUL_INT8 not defined, "
				"use the Q4_0_4_4 quantization format for optimal "
				"performance");
#else
	float sumf[4];
	int sumi;
...
void ggml_gemv_q4_0_8x8_q8_0(int n, float *restrict s, size_t bs,
							 const void *restrict vx, const void *restrict vy,
							 int nr, int nc) {
	const int qk				= QK8_0;
	const int nb				= n / qk;
	...
	if (ggml_sve_cnt_b == QK8_0) {
		...
		GGML_ASSERT((ggml_cpu_has_sve() && (ggml_sve_cnt_b == QK8_0)) &&
					"__ARM_FEATURE_SVE for vector size of 256-bits not "
					"defined, use the Q4_0_4_8 quantization format for optimal "
					"performance");
	...
	GGML_ASSERT(ggml_cpu_has_sve() &&
				"__ARM_FEATURE_SVE not defined, use the Q4_0_4_8 quantization "
				"format for optimal performance");
#elif defined(__ARM_NEON) && defined(__aarch64__)
	GGML_ASSERT((ggml_cpu_has_sve() || ggml_cpu_has_matmul_int8()) &&
				"__ARM_FEATURE_SVE and __ARM_FEATURE_MATMUL_INT8 not defined, "
		...
		for (int64_t x = 0; x < nc / 8; x++) {
			...
			for (int64_t b = 0; b < nb; b++) {
				...
				const __m256 row_scale_f32 =
					_mm256_set1_ps(GGML_FP16_TO_FP32(a_ptr[b].d));

				// Load the block values in block_q8_0 in batches of 16 bytes
				// and replicate the same across 256 bit vector
				__m256i lhs_vec_0 = _mm256_castsi128_si256(
				...
				lhs_vec_0 = _mm256_permute2f128_si256(lhs_vec_0, lhs_vec_0,
													  0); // A0 (0-15) A0(0-15)
				lhs_vec_1 = _mm256_permute2f128_si256(
					lhs_vec_1, lhs_vec_1, 0); // A0 (16-31) A0(16-31))

				__m256i iacc = _mm256_setzero_si256();

				// Dot product done within 32 bit lanes and accumulated in the
				// same vector B0(0-3) B4(0-3) B1(0-3) B5(0-3) B2(0-3) B6(0-3)
				...
				iacc = _mm256_add_epi32(
					iacc, mul_sum_i8_pairs_int(
							  _mm256_blend_epi32(
								  _mm256_shuffle_epi32(rhs_vec_0123_0, 177),
								  rhs_vec_4567_0, 170),
				...
				iacc = _mm256_add_epi32(
					iacc, mul_sum_i8_pairs_int(
							  _mm256_blend_epi32(
								  _mm256_shuffle_epi32(rhs_vec_0123_1, 177),
								  rhs_vec_4567_1, 170),
				...
				iacc = _mm256_add_epi32(
					iacc, mul_sum_i8_pairs_int(
							  _mm256_blend_epi32(
								  _mm256_shuffle_epi32(rhs_vec_0123_2, 177),
								  rhs_vec_4567_2, 170),
				...
				iacc = _mm256_add_epi32(
					iacc, mul_sum_i8_pairs_int(
							  _mm256_blend_epi32(
								  _mm256_shuffle_epi32(rhs_vec_0123_3, 177),
								  rhs_vec_4567_3, 170),
			...
			// Accumulated output values permuted so as to be stored in
			// appropriate order post accumulation
...
void ggml_gemm_q4_0_4x4_q8_0(int n, float *restrict s, size_t bs,
							 const void *restrict vx, const void *restrict vy,
							 int nr, int nc) {
	const int qk				= QK8_0;
	const int nb				= n / qk;
	...
	__asm__ __volatile__(
		...
		: "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8",
		  ...
		  "v29", "v30", "v31", "x9", "x10", "x20", "x21", "x22", "x23", "x24",
		  "x25", "x26", "x27", "x28");
#else
	float sumf[4][4];
	int sumi;
							...
							for (int i = 0; i < blocklen; ++i) {
								...
								const int v1 =
									(int8_t)(b_ptr[l].qs[k * ncols_interleaved *
														 ...
														 j * blocklen + i] &
											 0xF0);
								sumi += ((v0 * a_ptr[l].qs[k * 4 * blocklen +
														   m * blocklen + i]) +
										 (v1 * a_ptr[l].qs[k * 4 * blocklen +
														   m * blocklen + i +
														   qk / 2 * 4])) >>
										4;
							}
							sumf[m][j] += sumi *
										  GGML_FP16_TO_FP32(b_ptr[l].d[j]) *
										  GGML_FP16_TO_FP32(a_ptr[l].d[m]);
						}
					}
				}
			}
...
void ggml_gemm_q4_0_4x8_q8_0(int n, float *restrict s, size_t bs,
							 const void *restrict vx, const void *restrict vy,
							 int nr, int nc) {
	const int qk				= QK8_0;
	const int nb				= n / qk;
...
void ggml_gemm_q4_0_8x8_q8_0(int n, float *restrict s, size_t bs,
							 const void *restrict vx, const void *restrict vy,
							 int nr, int nc) {
	const int qk				= QK8_0;
	const int nb				= n / qk;
	...
	if (ggml_sve_cnt_b == QK8_0) {
		...
		__asm__ __volatile__("mov x20, #0x4\n"
							 ...
							 : [b_ptr] "r"(b_ptr), [nr] "r"(nr), [nb] "r"(nb),
							   [res_stride] "r"(res_stride), [nc] "r"(nc)
							 : "cc", "memory", "p0", "p1", "x9", "x10", "x11",
							   "x12", "x13", "x20", "x21", "x22", "x23", "x24",
							   "x25", "x26", "x27", "x28", "z0", "z1", "z2",
	...
	for (; y < anr / 4; y += 4) {
		...
		for (int64_t x = 0; x < nc / 8; x++) {
			...
			for (int64_t b = 0; b < nb; b++) {
				// Load the eight block_q4_0 quantized values interleaved with
				// each other in chunks of eight - B0,B1 ....B6,B7
				...
				// B0B1B4B5, B2B3B6B7 for further processing and storing of
				// values
				const __m256i rhs_raw_mat_0145_0 =
					_mm256_blend_epi32(rhs_raw_mat_0123_0,
									   _mm256_permutevar8x32_epi32(
										   rhs_raw_mat_4567_0, requiredOrder),
									   240);
				const __m256i rhs_raw_mat_2367_0 =
					_mm256_blend_epi32(_mm256_permutevar8x32_epi32(
										   rhs_raw_mat_0123_0, requiredOrder),
									   rhs_raw_mat_4567_0, 240);
				const __m256i rhs_raw_mat_0145_1 =
					_mm256_blend_epi32(rhs_raw_mat_0123_1,
									   _mm256_permutevar8x32_epi32(
										   rhs_raw_mat_4567_1, requiredOrder),
									   240);
				const __m256i rhs_raw_mat_2367_1 =
					_mm256_blend_epi32(_mm256_permutevar8x32_epi32(
										   rhs_raw_mat_0123_1, requiredOrder),
				...
				const __m256i rhs_mat_0145_2_sp1 = _mm256_shuffle_epi32(
					rhs_mat_0145_2,
					136); // B0(16-19) B1(16-19) B0(16-19) B1(16-19) B4(16-19)
						  // B5(16-19) B4(16-19) B5(16-19)
				const __m256i rhs_mat_2367_2_sp1 = _mm256_shuffle_epi32(
					rhs_mat_2367_2,
					136); // B2(16-19) B3(16-19) B2(16-19) B3(16-19) B6(16-19)
						  // B7(16-19) B6(16-19) B7(16-19)

				const __m256i rhs_mat_0145_3_sp1 = _mm256_shuffle_epi32(
					rhs_mat_0145_3,
					136); // B0(24-27) B1(24-27) B0(24-27) B1(24-27) B4(24-27)
						  // B5(24-27) B4(24-27) B5(24-27)
				const __m256i rhs_mat_2367_3_sp1 = _mm256_shuffle_epi32(
					rhs_mat_2367_3,
					136); // B2(24-27) B3(24-27) B2(24-27) B3(24-27) B6(24-27)
						  // B7(24-27) B6(24-27) B7(24-27)

				// Shuffle pattern two - right side input

				const __m256i rhs_mat_0145_0_sp2 = _mm256_shuffle_epi32(
					rhs_mat_0145_0, 221); // B0(4-7) B1(4-7) B0(4-7) B1(4-7)
										  // B4(4-7) B5(4-7) B4(4-7) B5(4-7)
				const __m256i rhs_mat_2367_0_sp2 = _mm256_shuffle_epi32(
					rhs_mat_2367_0, 221); // B2(4-7) B3(4-7) B2(4-7) B3(4-7)
										  // B6(4-7) B7(4-7) B6(4-7) B7(4-7)

				const __m256i rhs_mat_0145_1_sp2 = _mm256_shuffle_epi32(
					rhs_mat_0145_1,
					221); // B0(12-15) B1(12-15) B0(12-15) B1(12-15) B4(12-15)
						  // B5(12-15) B4(12-15) B5(12-15)
				const __m256i rhs_mat_2367_1_sp2 = _mm256_shuffle_epi32(
					rhs_mat_2367_1,
					221); // B2(12-15) B3(12-15) B2(12-15) B3(12-15) B6(12-15)
						  // B7(12-15) B6(12-15) B7(12-15)

				const __m256i rhs_mat_0145_2_sp2 = _mm256_shuffle_epi32(
					rhs_mat_0145_2,
					221); // B0(20-23) B1(20-23) B0(20-23) B1(20-23) B4(20-23)
						  // B5(20-23) B4(20-23) B5(20-23)
				const __m256i rhs_mat_2367_2_sp2 = _mm256_shuffle_epi32(
					rhs_mat_2367_2,
					221); // B2(20-23) B3(20-23) B2(20-23) B3(20-23) B6(20-23)
						  // B7(20-23) B6(20-23) B7(20-23)

				const __m256i rhs_mat_0145_3_sp2 = _mm256_shuffle_epi32(
					rhs_mat_0145_3,
					221); // B0(28-31) B1(28-31) B0(28-31) B1(28-31) B4(28-31)
						  // B5(28-31) B4(28-31) B5(28-31)
				const __m256i rhs_mat_2367_3_sp2 = _mm256_shuffle_epi32(
					rhs_mat_2367_3,
					221); // B2(28-31) B3(28-31) B2(28-31) B3(28-31) B6(28-31)
						  // B7(28-31) B6(28-31) B7(28-31)
				...
				for (int rp = 0; rp < 4; rp++) {
					// Load the four block_q4_0 quantized values interleaved
					// with each other in chunks of eight - A0,A1,A2,A3 Loaded
					// as set of 128 bit vectors and repeated into a 256 bit
					// vector
					__m256i lhs_mat_0123_0 = _mm256_loadu_si256(
						(const __m256i *)((a_ptrs[rp][b].qs)));
					__m256i lhs_mat_01_0 = _mm256_permute2f128_si256(
						lhs_mat_0123_0, lhs_mat_0123_0, 0);
					__m256i lhs_mat_23_0 = _mm256_permute2f128_si256(
						lhs_mat_0123_0, lhs_mat_0123_0, 17);
					__m256i lhs_mat_0123_1 = _mm256_loadu_si256(
						(const __m256i *)((a_ptrs[rp][b].qs + 32)));
					__m256i lhs_mat_01_1 = _mm256_permute2f128_si256(
						lhs_mat_0123_1, lhs_mat_0123_1, 0);
					__m256i lhs_mat_23_1 = _mm256_permute2f128_si256(
						lhs_mat_0123_1, lhs_mat_0123_1, 17);
					__m256i lhs_mat_0123_2 = _mm256_loadu_si256(
						(const __m256i *)((a_ptrs[rp][b].qs + 64)));
					__m256i lhs_mat_01_2 = _mm256_permute2f128_si256(
						lhs_mat_0123_2, lhs_mat_0123_2, 0);
					__m256i lhs_mat_23_2 = _mm256_permute2f128_si256(
						lhs_mat_0123_2, lhs_mat_0123_2, 17);
					__m256i lhs_mat_0123_3 = _mm256_loadu_si256(
						(const __m256i *)((a_ptrs[rp][b].qs + 96)));
					__m256i lhs_mat_01_3 = _mm256_permute2f128_si256(
						lhs_mat_0123_3, lhs_mat_0123_3, 0);
					__m256i lhs_mat_23_3 = _mm256_permute2f128_si256(
						lhs_mat_0123_3, lhs_mat_0123_3, 17);

					// Shuffle pattern one - left side input
					const __m256i lhs_mat_01_0_sp1 = _mm256_shuffle_epi32(
						lhs_mat_01_0, 160); // A0(0-3) A0(0-3) A1(0-3) A1(0-3)
											// A0(0-3) A0(0-3) A1(0-3) A1(0-3)
					const __m256i lhs_mat_23_0_sp1 = _mm256_shuffle_epi32(
						lhs_mat_23_0, 160); // A2(0-3) A2(0-3) A3(0-3) A3(0-3)
											// A2(0-3) A2(0-3) A3(0-3) A3(0-3)

					const __m256i lhs_mat_01_1_sp1 = _mm256_shuffle_epi32(
						lhs_mat_01_1,
						160); // A0(8-11) A0(8-11) A1(8-11) A1(8-11) A0(8-11)
							  // A0(8-11) A1(8-11) A1(8-11)
					const __m256i lhs_mat_23_1_sp1 = _mm256_shuffle_epi32(
						lhs_mat_23_1,
						160); // A2(8-11) A2(8-11) A3(8-11) A3(8-11) A2(8-11)
							  // A2(8-11) A3(8-11) A3(8-11)

					const __m256i lhs_mat_01_2_sp1 = _mm256_shuffle_epi32(
						lhs_mat_01_2,
						160); // A0(16-19) A0(16-19) A1(16-19) A1(16-19)
							  // A0(16-19) A0(16-19) A1(16-19) A1(16-19)
					const __m256i lhs_mat_23_2_sp1 = _mm256_shuffle_epi32(
						lhs_mat_23_2,
						160); // A2(16-19) A2(16-19) A3(16-19) A3(16-19)
							  // A2(16-19) A2(16-19) A3(16-19) A3(16-19)

					const __m256i lhs_mat_01_3_sp1 = _mm256_shuffle_epi32(
						lhs_mat_01_3,
						160); // A0(24-27) A0(24-27) A1(24-27) A1(24-27)
							  // A0(24-27) A0(24-27) A1(24-27) A1(24-27)
					const __m256i lhs_mat_23_3_sp1 = _mm256_shuffle_epi32(
						lhs_mat_23_3,
						160); // A2(24-27) A2(24-27) A3(24-27) A3(24-27)
							  // A2(24-27) A2(24-27) A3(24-27) A3(24-27)

					// Shuffle pattern two - left side input
					const __m256i lhs_mat_01_0_sp2 = _mm256_shuffle_epi32(
						lhs_mat_01_0, 245); // A0(4-7) A0(4-7) A1(4-7) A1(4-7)
											// A0(4-7) A0(4-7) A1(4-7) A1(4-7)
					const __m256i lhs_mat_23_0_sp2 = _mm256_shuffle_epi32(
						lhs_mat_23_0, 245); // A2(4-7) A2(4-7) A3(4-7) A3(4-7)
											// A2(4-7) A2(4-7) A3(4-7) A3(4-7)

					const __m256i lhs_mat_01_1_sp2 = _mm256_shuffle_epi32(
						lhs_mat_01_1,
						245); // A0(12-15) A0(12-15) A1(12-15) A1(12-15)
							  // A0(12-15) A0(12-15) A1(12-15) A1(12-15)
					const __m256i lhs_mat_23_1_sp2 = _mm256_shuffle_epi32(
						lhs_mat_23_1,
						245); // A2(12-15) A2(12-15) A3(12-15) A3(12-15)
							  // A2(12-15) A2(12-15) A3(12-15) A3(12-15)

					const __m256i lhs_mat_01_2_sp2 = _mm256_shuffle_epi32(
						lhs_mat_01_2,
						245); // A0(20-23) A0(20-23) A1(20-23) A1(20-23)
							  // A0(20-23) A0(20-23) A1(20-23) A1(20-23)
					const __m256i lhs_mat_23_2_sp2 = _mm256_shuffle_epi32(
						lhs_mat_23_2,
						245); // A2(20-23) A2(20-23) A3(20-23) A3(20-23)
							  // A2(20-23) A2(20-23) A3(20-23) A3(20-23)

					const __m256i lhs_mat_01_3_sp2 = _mm256_shuffle_epi32(
						lhs_mat_01_3,
						245); // A0(28-31) A0(28-31) A1(28-31) A1(28-31)
							  // A0(28-31) A0(28-31) A1(28-31) A1(28-31)
					const __m256i lhs_mat_23_3_sp2 = _mm256_shuffle_epi32(
						lhs_mat_23_3,
						245); // A2(28-31) A2(28-31) A3(28-31) A3(28-31)
							  // A2(28-31) A2(28-31) A3(28-31) A3(28-31)

					// The values arranged in shuffle patterns are operated with
					// dot product operation within 32 bit lane i.e
					// corresponding bytes and multiplied and added into 32 bit
					// integers within 32 bit lane Resembles MMLAs into 2x2
					// matrices in ARM Version
					__m256i iacc_mat_00_sp1 = _mm256_add_epi32(
						_mm256_add_epi32(
							_mm256_add_epi32(
								mul_sum_i8_pairs_int(lhs_mat_01_3_sp1,
													 rhs_mat_0145_3_sp1),
								mul_sum_i8_pairs_int(lhs_mat_01_2_sp1,
													 rhs_mat_0145_2_sp1)),
							mul_sum_i8_pairs_int(lhs_mat_01_1_sp1,
												 rhs_mat_0145_1_sp1)),
						mul_sum_i8_pairs_int(lhs_mat_01_0_sp1,
											 rhs_mat_0145_0_sp1));
					...
					__m256i iacc_mat_10_sp1 = _mm256_add_epi32(
						_mm256_add_epi32(
							_mm256_add_epi32(
								mul_sum_i8_pairs_int(lhs_mat_23_3_sp1,
													 rhs_mat_0145_3_sp1),
								mul_sum_i8_pairs_int(lhs_mat_23_2_sp1,
													 rhs_mat_0145_2_sp1)),
							mul_sum_i8_pairs_int(lhs_mat_23_1_sp1,
												 rhs_mat_0145_1_sp1)),
						mul_sum_i8_pairs_int(lhs_mat_23_0_sp1,
											 rhs_mat_0145_0_sp1));
					...
					__m256i iacc_mat_00_sp2 = _mm256_add_epi32(
						_mm256_add_epi32(
							_mm256_add_epi32(
								mul_sum_i8_pairs_int(lhs_mat_01_3_sp2,
													 rhs_mat_0145_3_sp2),
								mul_sum_i8_pairs_int(lhs_mat_01_2_sp2,
													 rhs_mat_0145_2_sp2)),
							mul_sum_i8_pairs_int(lhs_mat_01_1_sp2,
												 rhs_mat_0145_1_sp2)),
						mul_sum_i8_pairs_int(lhs_mat_01_0_sp2,
											 rhs_mat_0145_0_sp2));
					...
					__m256i iacc_mat_10_sp2 = _mm256_add_epi32(
						_mm256_add_epi32(
							_mm256_add_epi32(
								mul_sum_i8_pairs_int(lhs_mat_23_3_sp2,
													 rhs_mat_0145_3_sp2),
								mul_sum_i8_pairs_int(lhs_mat_23_2_sp2,
													 rhs_mat_0145_2_sp2)),
							mul_sum_i8_pairs_int(lhs_mat_23_1_sp2,
												 rhs_mat_0145_1_sp2)),
						mul_sum_i8_pairs_int(lhs_mat_23_0_sp2,
											 rhs_mat_0145_0_sp2));
					...
					// Output of both shuffle patterns are added in order to sum
					// dot product outputs of all 32 values in block
					__m256i iacc_mat_00 =
					...
					__m256i iacc_row_0 = _mm256_blend_epi32(
						iacc_mat_00, _mm256_shuffle_epi32(iacc_mat_01, 78),
						204);
					__m256i iacc_row_1 = _mm256_blend_epi32(
						_mm256_shuffle_epi32(iacc_mat_00, 78), iacc_mat_01,
						204);
					__m256i iacc_row_2 = _mm256_blend_epi32(
						iacc_mat_10, _mm256_shuffle_epi32(iacc_mat_11, 78),
						204);
					__m256i iacc_row_3 = _mm256_blend_epi32(
						_mm256_shuffle_epi32(iacc_mat_10, 78), iacc_mat_11,
						204);

					// Load the scale(d) values for all the 4 Q8_0 blocks and
					// repeat it across lanes
					const __m256 row_scale_f32 =
					...
					acc_rows[rp * 4 + 1] = _mm256_fmadd_ps(
						...
						_mm256_mul_ps(col_scale_f32,
									  _mm256_shuffle_ps(row_scale_f32,
														row_scale_f32, 85)),
						acc_rows[rp * 4 + 1]);
	...
	for (; y < nr / 4; y++) {
		...
		for (int64_t x = 0; x < nc / 8; x++) {
			...
			for (int64_t b = 0; b < nb; b++) {
				// Load the eight block_q8_0 quantized values interleaved with
				// each other in chunks of eight - B0,B1 ....B6,B7
				const __m256i rhs_raw_mat_0123_0 =
					_mm256_loadu_si256((const __m256i *)(b_ptr[b].qs));
				const __m256i rhs_raw_mat_4567_0 =
				...
				// Load the four block_q4_0 quantized values interleaved with
				// each other in chunks of eight - A0,A1,A2,A3 Loaded as set of
				// 128 bit vectors and repeated into a 256 bit vector
				...
				const __m256i lhs_mat_01_2_sp1 = _mm256_shuffle_epi32(
					lhs_mat_01_2,
					160); // A0(16-19) A0(16-19) A1(16-19) A1(16-19) A0(16-19)
						  // A0(16-19) A1(16-19) A1(16-19)
				const __m256i lhs_mat_23_2_sp1 = _mm256_shuffle_epi32(
					lhs_mat_23_2,
					160); // A2(16-19) A2(16-19) A3(16-19) A3(16-19) A2(16-19)
						  // A2(16-19) A3(16-19) A3(16-19)

				const __m256i lhs_mat_01_3_sp1 = _mm256_shuffle_epi32(
					lhs_mat_01_3,
					160); // A0(24-27) A0(24-27) A1(24-27) A1(24-27) A0(24-27)
						  // A0(24-27) A1(24-27) A1(24-27)
				const __m256i lhs_mat_23_3_sp1 = _mm256_shuffle_epi32(
					lhs_mat_23_3,
					160); // A2(24-27) A2(24-27) A3(24-27) A3(24-27) A2(24-27)
						  // A2(24-27) A3(24-27) A3(24-27)
				...
				const __m256i lhs_mat_01_1_sp2 = _mm256_shuffle_epi32(
					lhs_mat_01_1,
					245); // A0(12-15) A0(12-15) A1(12-15) A1(12-15) A0(12-15)
						  // A0(12-15) A1(12-15) A1(12-15)
				const __m256i lhs_mat_23_1_sp2 = _mm256_shuffle_epi32(
					lhs_mat_23_1,
					245); // A2(12-15) A2(12-15) A3(12-15) A3(12-15) A2(12-15)
						  // A2(12-15) A3(12-15) A3(12-15)

				const __m256i lhs_mat_01_2_sp2 = _mm256_shuffle_epi32(
					lhs_mat_01_2,
					245); // A0(20-23) A0(20-23) A1(20-23) A1(20-23) A0(20-23)
						  // A0(20-23) A1(20-23) A1(20-23)
				const __m256i lhs_mat_23_2_sp2 = _mm256_shuffle_epi32(
					lhs_mat_23_2,
					245); // A2(20-23) A2(20-23) A3(20-23) A3(20-23) A2(20-23)
						  // A2(20-23) A3(20-23) A3(20-23)

				const __m256i lhs_mat_01_3_sp2 = _mm256_shuffle_epi32(
					lhs_mat_01_3,
					245); // A0(28-31) A0(28-31) A1(28-31) A1(28-31) A0(28-31)
						  // A0(28-31) A1(28-31) A1(28-31)
				const __m256i lhs_mat_23_3_sp2 = _mm256_shuffle_epi32(
					lhs_mat_23_3,
					245); // A2(28-31) A2(28-31) A3(28-31) A3(28-31) A2(28-31)
						  // A2(28-31) A3(28-31) A3(28-31)

				// The values arranged in shuffle patterns are operated with dot
				// product operation within 32 bit lane i.e corresponding bytes
				// and multiplied and added into 32 bit integers within 32 bit
				// lane Resembles MMLAs into 2x2 matrices in ARM Version
				__m256i iacc_mat_00_sp1 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_01_3_sp1,
						...
						mul_sum_i8_pairs_int(lhs_mat_01_1_sp1,
											 rhs_mat_0145_1_sp1)),
					mul_sum_i8_pairs_int(lhs_mat_01_0_sp1, rhs_mat_0145_0_sp1));
				__m256i iacc_mat_01_sp1 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_01_3_sp1,
						...
						mul_sum_i8_pairs_int(lhs_mat_01_1_sp1,
											 rhs_mat_2367_1_sp1)),
					mul_sum_i8_pairs_int(lhs_mat_01_0_sp1, rhs_mat_2367_0_sp1));
				__m256i iacc_mat_10_sp1 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_23_3_sp1,
						...
						mul_sum_i8_pairs_int(lhs_mat_23_1_sp1,
											 rhs_mat_0145_1_sp1)),
					mul_sum_i8_pairs_int(lhs_mat_23_0_sp1, rhs_mat_0145_0_sp1));
				__m256i iacc_mat_11_sp1 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_23_3_sp1,
						...
						mul_sum_i8_pairs_int(lhs_mat_23_1_sp1,
											 rhs_mat_2367_1_sp1)),
					mul_sum_i8_pairs_int(lhs_mat_23_0_sp1, rhs_mat_2367_0_sp1));
				__m256i iacc_mat_00_sp2 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_01_3_sp2,
						...
						mul_sum_i8_pairs_int(lhs_mat_01_1_sp2,
											 rhs_mat_0145_1_sp2)),
					mul_sum_i8_pairs_int(lhs_mat_01_0_sp2, rhs_mat_0145_0_sp2));
				__m256i iacc_mat_01_sp2 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_01_3_sp2,
						...
						mul_sum_i8_pairs_int(lhs_mat_01_1_sp2,
											 rhs_mat_2367_1_sp2)),
					mul_sum_i8_pairs_int(lhs_mat_01_0_sp2, rhs_mat_2367_0_sp2));
				__m256i iacc_mat_10_sp2 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_23_3_sp2,
						...
						mul_sum_i8_pairs_int(lhs_mat_23_1_sp2,
											 rhs_mat_0145_1_sp2)),
					mul_sum_i8_pairs_int(lhs_mat_23_0_sp2, rhs_mat_0145_0_sp2));
				__m256i iacc_mat_11_sp2 = _mm256_add_epi32(
					_mm256_add_epi32(
						_mm256_add_epi32(
							mul_sum_i8_pairs_int(lhs_mat_23_3_sp2,
						...
						mul_sum_i8_pairs_int(lhs_mat_23_1_sp2,
											 rhs_mat_2367_1_sp2)),
					mul_sum_i8_pairs_int(lhs_mat_23_0_sp2, rhs_mat_2367_0_sp2));
				...
				// Load the scale(d) values for all the 4 Q8_0 blocks and repeat
				// it across lanes
				const __m256 row_scale_f32 =
