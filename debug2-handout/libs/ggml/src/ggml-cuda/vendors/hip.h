...
#define cublasComputeType_t                                                    \
	hipblasDatatype_t // deprecated, new hipblasComputeType_t not in 5.6
...
#define cudaDataType_t                                                         \
	hipblasDatatype_t // deprecated, new hipblasDatatype not in 5.6
...
static __device__ __forceinline__ unsigned int __vcmpeq4(unsigned int a,
														 unsigned int b) {
...
static __device__ __forceinline__ unsigned int __vcmpne4(unsigned int a,
														 unsigned int b) {
	const uint8x4_t &va = reinterpret_cast<const uint8x4_t &>(a);
	const uint8x4_t &vb = reinterpret_cast<const uint8x4_t &>(b);
	unsigned int c;
...
static __device__ __forceinline__ half2 __shfl_xor(half2 var, int laneMask,
												   int width) {
